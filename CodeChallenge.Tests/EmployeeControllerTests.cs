...
namespace CodeCodeChallenge.Tests.Integration
{
    ...
    public class EmployeeControllerTests
    {
        ...
        //New Test Method to test getReportingStructureById
        [TestMethod]
        ...
        public void CreateCompensation_Returns_Created()
        {
            ...
            var compensation = new Compensation()
            {
                ...
                Salary = 100000,
                EffectiveDate = new System.DateTime(2024,9,2),
            };
        ...
        //New Test Method to test GetCompensationById
        [TestMethod]
        public void GetCompensationById_Returns_Ok()
        {
            // Arrange
            var employeeId = "03aa1462-ffa9-4978-901b-7c001562cf6f";
            var expectedSalary = 110000;
            var expectedEffectiveDate = new DateTime(2024, 4, 23);
            // Execute
